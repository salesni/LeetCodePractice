...
class Solution:
    def canChange(self, start: str, target: str) -> bool:
        ...
        while start_index < length or end_index < length:

            while end_index < length and target[end_index] == "_":
                end_index += 1
            while start_index < length and start[start_index] == "_":
                start_index += 1

            if start_index == length or end_index == length:
                return start_index == end_index

            if start[start_index] == target[end_index]:
